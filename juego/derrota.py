...
def mostrar_derrota(pantalla, usuario, clock):
    ...
    while mostrando:
        ...
        titulo_surf = font_titulo.render("¡Has perdido!", True, (255, 0, 0))
        msg_surf = font_texto.render(f"{usuario}, un enemigo llegó al final", True, (255, 255, 255))
